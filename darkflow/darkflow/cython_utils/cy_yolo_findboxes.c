 ...
 *     cdef:
 */
  __pyx_tuple__21 = PyTuple_Pack(18, __pyx_n_s_meta, __pyx_n_s_net_out, __pyx_n_s_threshold, __pyx_n_s_sqrt, __pyx_n_s_C, __pyx_n_s_B, __pyx_n_s_S, __pyx_n_s_SS, __pyx_n_s_prob_size, __pyx_n_s_conf_size, __pyx_n_s_grid, __pyx_n_s_b, __pyx_n_s_class_loop, __pyx_n_s_boxes, __pyx_n_s_probs, __pyx_n_s_confs, __pyx_n_s_coords, __pyx_n_s_final_probs); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__21);
  __Pyx_GIVEREF(__pyx_tuple__21);
  __pyx_codeobj__22 = (PyObject*)__Pyx_PyCode_New(3, 0, 18, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_darkflow_cython_utils_cy_yolo_fi, __pyx_n_s_yolo_box_constructor, 14, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__22)) __PYX_ERR(0, 14, __pyx_L1_error)
