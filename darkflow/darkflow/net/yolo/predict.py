...
def postprocess(self, net_out, im, save = True):
	...
	for b in boxes:
		...
		img_path = os.path.join(out_folder, os.path.basename(im))
		if '2.jpg' in img_path:
			print(left, right, top, bot, mess, max_indx, confidence, img_path)
		# print('----------------------- left: %s' % left)
		# print('----------------------- right: %s' % right)
		# print('----------------------- top: %s' % top)
		# print('----------------------- bot: %s' % bot)
		# print('----------------------- mess: %s' % mess)
		# print('----------------------- max_indx: %s' % max_indx)
		# print('----------------------- confidence: %s' % confidence)
		# print('----------------------- confidence type: %s' % type(confidence))
		cv2.rectangle(imgcv,
			(left, top), (right, bot),
	...
	# print('----------------------- generate prediction: %s' % img_name)
